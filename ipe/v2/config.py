...
# --------------------------------------------------------------------------- #
# 초급(easy track) abstract 도메인 센티넬 — 스토리/도메인 orthogonal 선택.          #
#   strategist 가 is_basic 문제에서 run_id-seeded 로 abstract 를 고르면 domain 을    #
#   이 값으로 스탬프 → narrative 가 도메인 스토리 대신 맨 수식/IO 로 직접 서술한다.    #
#   단일 진실원천: strategist 가 set, narrative 가 read (난이도 seed-파생과 동형).    #
# --------------------------------------------------------------------------- #
ABSTRACT_DOMAIN = "abstract"
