...
window.IPE_DATA = {
  meta: {
    ...
    // 코드 베이스 (측정값)
    tests: 531,                     // v1 520 + v2 11 passed, 2 skipped (533 collected)
    testsSkipped: 2,
  ...
  milestones: [
    ...
    { id: "M3", title: "모델링 layer — 알고리즘 은닉 (Strategist/Narrative/Formalizer)", status: "in_progress", ref: "#114·#116·#117", note: "blueprint-first 아티팩트(#114) → ipe/v2 V2State scaffold(#116) → Strategist/Formalizer 2노드 분리 + blueprint freeze(#117). v1(canonical)은 CANONICAL.md 로 동결, v2 에서 B2B fresh 파이프라인 구축. toy → hiring-grade 전환점." },
